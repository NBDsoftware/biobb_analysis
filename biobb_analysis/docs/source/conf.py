...
htmlhelp_basename = "biobb_analysis_doc"
...
man_pages = [
    (master_doc, "biobb_analysis", "biobb_analysis Documentation", [author], 1)
]
...
texinfo_documents = [
    (
        ...
        author,
        "biobb_analysis",
        "biobb_analysis molecular dynamics analysis building blocks",
        "Miscellaneous",
    ),
]
