...
[![](https://img.shields.io/badge/Singularity-GalaxyProject-blue)](https://depot.galaxyproject.org/singularity/biobb_analysis:5.3.0--pyhdfd78af_0)
...
* Installation:
        ...
        pip install "biobb_analysis>=5.3.0"
...
* Installation:
        ...
        conda install -c bioconda "biobb_analysis>=5.3.0"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_analysis:5.3.0--pyhdfd78af_0


* Usage:


        docker run quay.io/biocontainers/biobb_analysis:5.3.0--pyhdfd78af_0 <command>
...
* Installation:
        ...
        singularity pull --name biobb_analysis.sif https://depot.galaxyproject.org/singularity/biobb_analysis:5.3.0--pyhdfd78af_0
